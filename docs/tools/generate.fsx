...
let referenceBinaries = ["Hyperobjects.dll"]
// Web site location for the generated documentation
let website = "/Hyperobjects"

let githubLink = "http://github.com/relayfoods/Hyperobjects"

// Specify more information about your project
let info =
  [ "project-name", "Hyperobjects"
    "project-author", "Retail Relay, Inc."
    "project-summary", "a framework for building RESTful event-sourced microservices following DDD patterns"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Hyperobjects" ]
